...
const MainFeature = () => {
  ...
  useEffect(() => {
const savedTasks = localStorage.getItem('tasker-tasks');
    if (savedTasks) {
            ...
            {filteredTasks.length === 0 ? (
              ...
              >
                ...
                <p className="text-surface-500 dark:text-surface-400 mb-6">
                  {tasks.length === 0 
                    ? 'Create your first task to get started with Tasker' 
...
const SortableTaskCard = ({ task, index, category, onToggleStatus, onEdit, onDelete, formatDueDate, getPriorityIcon }) => {
  const {
    attributes,
    listeners,
    setNodeRef,
    ...
    >
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div
          {...attributes}
          {...listeners}
          className="drag-handle flex-shrink-0 p-1 mt-1 cursor-grab active:cursor-grabbing hover:bg-surface-100 dark:hover:bg-surface-700 rounded transition-colors"
        >
